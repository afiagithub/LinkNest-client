    ...
    return (
        <div className='flex flex-col lg:flex-row justify-between'>
            <div className="lg:w-4/6 text-center mb-5 lg:mb-0 mt-5 lg:mt-10">
                ...
                <h2 className="text-2xl font-bold font-nun my-5">Welcome, {username}</h2>
                <div className="text-left ml-6 md:ml-10 lg:ml-12">
                    <p className="my-5 text-xl font-bold">My Profile: </p>
                    ...
                    <p className="font-bold">Hobbies:
                        {
                            hobbies.length > 0 ? hobbies.map(hobby => <span key={hobby} hobby={hobby}
                                className='badge badge-outline mx-2'>
                                {hobby}
                            </span>) : ''
                        }
                    </p>
